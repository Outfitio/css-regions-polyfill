/*! CSS-REGIONS-POLYFILL - v3.0.0 - 2016-11-30 - https://github.com/FremyCompany/css-regions-polyfill - Copyright (c) 2016 François REMY; MIT-Licensed !*/
...
module.exports = (function(window, document) { "use strict";
	...
	var CSS_TO_NOT_HIDE_ON_SAFARI = "@media screen and (min-color-index:0) and(-webkit-min-device-pixel-ratio:0) { @media { [data-css-regions-fragment-source][data-css-regions-cloned]{display:block!important} }}";
	CSS_STYLE += CSS_TO_NOT_HIDE_ON_SAFARI;
	...
	var cssRegions = {
		...
		extractOverflowingContent: function(region, dontOptimize) {
			...
			var fixNullRect = function() {
				if(!rect || (rect.bottom==0 && rect.top==0 && rect.left==0 && rect.right==0)) {
